...
class Viewer:
    ...
    def __init__(self, display_mode: bool = False):
    ...
    def display_images(self, 
        ...
        for i, img in enumerate(images):
            ax = axs_flat[i]
            used_cmap = None if (not self.is_binary_image(img) and error_mode) else cmap
    ...
    def display_slices(self, 
        ...
        for idx, volume in enumerate(volumes):
            ...
            is_binary = self.is_binary_image(volume)
            used_cmap = None if (not is_binary and error_mode) else cmap
            ...
            for j, d in enumerate(directions):
                ...
                im = ax.imshow(frame, cmap=used_cmap)
                ax.axis('off')
