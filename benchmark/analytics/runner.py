...
from core.config.benchmark import RunnerResults, RunnerResultsParsed
...
class AnalyticsRunner(AnalyticsBase):
    ...
    def _parse_results(self, results: RunnerResults, params: dict[str, list[float]]) -> RunnerResultsParsed:
    ...
    def get_hessian_figures(self, results_raw: RunnerResults, params: dict[str, list]) -> list[FigureData]:
    ...
    def get_enhancement_figures(self, results_raw: RunnerResults, params: dict[str, list]) -> list[FigureData]:
